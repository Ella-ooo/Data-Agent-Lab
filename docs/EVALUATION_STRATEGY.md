...
| --- | --- | --- | --- |
| 1 | `golden` | >= 70% Core golden pass | Shipped; current Core golden pass is 5/5 |
...
| S3 | Multi-table Core + field extractor | Join-loss golden trap (**done**); infiagent manifest script next |
